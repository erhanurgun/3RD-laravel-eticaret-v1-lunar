...
/**
 * Lunar Admin Panel - Staff translations.
 * Lunar Admin Panel - Personel çevirileri.
 */
...
return [
    ...
    'form' => [
        ...
        'admin' => [
            ...
            'helper' => 'Süper yönetici rolleri hub\'da değiştirilemez.',
        ],
        'roles' => [
            'label' => 'Roller',
    ...
    'acl' => [
        ...
        'tooltip' => [
            'roles-included' => 'İzin şu rollere dahil',
        ],
        'notification' => [
            'updated' => 'Güncellendi',
            'error' => 'Hata',
